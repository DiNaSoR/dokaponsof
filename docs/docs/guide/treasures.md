...
Complete reference for all treasures and their effects in DOKAPON! Sword of Fury.
{: .fs-6 .fw-300 }
...
## Treasure System Overview

### Key Mechanics

- **Appraisal**: Treasures must be appraised at Item Shops (100G per item) to reveal their value
- **Effects**: In Remaster, effects activate immediately; in PS version, only after appraisal
- **Value**: Adds to total assets calculation
- **Stacking**: Some treasures can stack effects with multiple copies
- **Combination**: Some treasures combine into new items
- **Garmets**: Can be bought/sold at Garmets shop on Sundays
  - Appraised: Sells for half value
  - Unappraised: Sells for 100G

### Obtaining Methods

- **Village**: Excavation in villages
- **? Space**: Random events on ? spaces
- **Garmets**: Shop purchases (Sundays only)
- **Events**: Field events, rewards, casino, etc.
- **Monsters**: Drops from defeated monsters
...
| 91 | ☆ | ドカポンクラウン | Dokapon Crown | | | | | 640,000 | All Stats +10 |
| 92 | ☆ | ドカポンハート | Dokapon Heart | | | | Monster | 1,200,000 | Magic +10, HP +10 |
| 93 | ☆ | ドカポンリング | Dokapon Ring | | | | Casino | 640,000 | Attack +10, Defense +10, Speed +10 |

### Negative Effect Treasures
...
| # | Rarity | Name (JP) | Name (EN) | Village | ? Space | Garmets | Event | Value | Effect |
|---|--------|-----------|-----------|---------|---------|---------|-------|-------|--------|
| 95 | ★★★ | 弱の玉 | Weak Ball | | | | Getus | 1,000 | Part of Dokapon Ball |
| 96 | ★★★ | 肉の玉 | Meat Ball | | | | Lost Dog Punch | 1,000 | Part of Dokapon Ball |
| 97 | ★★★ | 強の玉 | Strong Ball | | | | Mystery Man | 1,000 | Part of Dokapon Ball |
| 98 | ★★★ | 食の玉 | Food Ball | | | | Junky (Allied) | 1,000 | Part of Dokapon Ball |
| 99 | ☆ | ドカポンボール | Dokapon Ball | | | | Synthesis | 99,999,999 | None |

---

## Treasure Combination Guide

### Skull Stone
Combine all 4 parts to create:
- **Something Fragment** (#22)
- **Something Part** (#23)
- **Something Piece** (#24)
- **Something Shard** (#25)

**Result**: Skull Stone (#21) - Value: 5,000,000G

### Shining Seasons
Combine all 4 seasonal parts to create:
- **Spring Romance** (#75)
- **Summer Memories** (#76)
- **Autumn Twilight** (#77)
- **Winter is Nabe** (#78)

**Result**: Shining Seasons (#74) - Value: 500,000G

### Dokapon Ball
Combine all 4 balls to create:
- **Weak Ball** (#95)
- **Meat Ball** (#96)
- **Strong Ball** (#97)
- **Food Ball** (#98)

**Result**: Dokapon Ball (#99) - Value: 99,999,999G

---

## Rarity Guide

| Symbol | Rarity | Description |
|--------|--------|-------------|
| ★ | 1 Star | Common treasures |
| ★★ | 2 Star | Uncommon treasures |
| ★★★ | 3 Star | Rare treasures |
| ☆ | Special | Legendary/Ultra rare treasures |
| BAD | Bad | Negative effect treasures |

---

## Obtaining Methods Reference

| Method | Description |
|--------|-------------|
| **Village** | Can be excavated from villages |
| **? Space** | Can be obtained from ? space events |
| **Garmets** | Can be purchased from Garmets shop (Sundays only) |
| **Reward** | Obtained as a reward from events |
| **Casino** | Obtained from casino games |
| **Monster** | Dropped by monsters |
| **Synthesis** | Created by combining other treasures |
| **Getus** | Obtained from Getus field events |
| **Lost Dog Punch** | Obtained from Lost Dog Punch events |
| **Mystery Man** | Obtained from Mystery Man events |
| **Junky (Allied)** | Obtained when allied with Junky |
| **Village Chief's Granddaughter** | Obtained from Village Chief's Granddaughter events |
| **Mercy** | Obtained from mercy events |
...
{: .note }
> **Village & ? Space Data**  
> The village and ? space columns show only confirmed obtained items from the source guide (471 villages total). For detailed ? space information, refer to the ? Space guide.

{: .important }
> **Treasure Effects**  
> - Effects activate immediately in Remaster version
> - Effects only activate after appraisal in PS version
> - Some treasures can stack effects with multiple copies
> - Negative effect treasures should be avoided or removed quickly

---

## See Also

- [Items](items) - Consumable items and equipment
- [Equipment](equipment) - Weapons and armor
- [Special Skills](special-skills) - Monster skills that treasures protect against
- [Battle Mechanics](battle-mechanics) - How treasure effects work in combat
