...
| **2 Spinner** | 700 | Get 2 spinners |
| **3 Spinner** | 2,000 | Get 3 spinners |
| **4 Spinner** | 5,500 | Get 4 spinners |
| **5 Spinner** | 16,000 | Get 5 spinners |
| **Spinner Up** | 23,000 | Spinners increase by 1 each turn (2→5) |
| **Spin Spinner** | 30,000 | Get 2-5 spinners for 5-7 turns |
| **Town Warp** | 600 | Jump to any village |
| **Store Warp** | 1,100 | Jump to any shop |
| **Field Warp** | 15,000 | Return to Dokapon Castle or your village |
| **Exit** | 1,500 | Exit dungeon to continent entrance |

### Recovery Items

| Name | Cost | Effect |
|:-----|:-----|:-------|
| **Potion** | 600 | Restore HP to half max |
| **Elixir** | 1,500 | Restore HP to maximum |
| **Revive** | 20,000 | Auto-revive when HP reaches 0 |
| **Pure Mop** | 2,100 | Cure Curse and Possession |
| **Panacea** | 1,500 | Cure Poison, Paralysis, and Seal |
| **Sleep Off** | 1,600 | Prevent Sleep and Drunk status |
| **Cureall** | 500 | Cure all status effects including Ebola |

### Stat Boost Items

| Name | Cost | Effect |
|:-----|:-----|:-------|
| **Peppy Meal** | 300 | +50% AT for 4-6 turns |
| **Crunchy Soba** | 300 | +50% DF for 4-6 turns |
| **Magic Fruit** | 300 | +50% MG for 4-6 turns |
| **Speedy Kicks** | 300 | +50% SP for 4-6 turns |
...
| Name | Cost | Effect |
|:-----|:-----|:-------|
| **Trap Dodger** | 500 | Avoid one trap |
| **Vanish** | 8,000 | Become invisible for 5-7 turns |
| **Forecast** | 10,000 | See battle coin once |
| **Magic Key** | 500 | Open locked treasure chests |
| **Bounce** | 5,000 | Nullify one field magic |
| **Mattock** | 250 | Destroy all rocks on map |
| **Angel Wings** | 12,000 | Revive next turn if defeated |
...
| **Footsore** | 2,800 | Become walking rock for 5-7 turns |
| **Trap** | 800 | Set trap on current space |
| **Grifter** | 1,200 | Steal one item (90% success) |
| **Cash Grab** | 5,000 | Steal 20% of money (90% success) |
| **Sweetsop** | 20,000 | Take over village when used on mayor |
...
| **Nitro** | 0 | May explode when damaged |
| **Gomba** | 0 | Automatically eats items one by one |
| **Blackmail** | 0 | ~20% chance of Reaper appearing each turn |
| **Cursed Idol** | 2 | Inflicts status effects if not sold in 7 turns |

### Special Items

| Name | Cost | Effect |
|:-----|:-----|:-------|
| **Contract** | 2 | Transform into Darkling with bat |
| **Disguise** | 50,000 | Disguise as random player for 1 turn |
| **Gold Bug** | 40,000 | 50% chance to double/zero money |
| **Money Spinner** | 50,000 | Get money based on week × 1000G × spinner |
| **Parcel** | 0 | Deliver to village for treasure |
...
| Name | Cost | Effect |
|:-----|:-----|:-------|
| **Revenge Honey** | 100,000 | Reusable Sweetsop (1/8 break chance) |
| **Revenge Rock** | 100,000 | Placeable rock lasting 4 turns |
| **Revenge Revive** | 100,000 | Reusable Revive (1/8 break chance) |
| **Revenge Gift** | 100,000 | Cause plague in target village |
| **Revenge Mirror** | 100,000 | Reusable Bounce (1/8 break chance) |
