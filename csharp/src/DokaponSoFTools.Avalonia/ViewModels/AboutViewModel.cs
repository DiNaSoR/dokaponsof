...
public sealed partial class AboutViewModel : ObservableObject
{
    ...
    public string Description => """
        ...
        - Animation Viewer: Preview and export spranm sprite animations
        - Game Scanner: Analyze game directory structure

        Built with C#/.NET 8 and Avalonia UI (cross-platform: Windows, macOS, Linux).
        Originally ported from the Python/PyQt6 application; UI rebuilt in Avalonia.
        """;
    ...
    [RelayCommand]
    private void PressF() => FPressCount++;
}
